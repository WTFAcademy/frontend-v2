...
- Animation: `framer-motion` 和 参考 [animata](https://animata.design/) 或 [magicui](https://magicui.design/) 或 [reactbits](https://www.reactbits.dev/) 或 [ui.aceternity](https://ui.aceternity.com/)
