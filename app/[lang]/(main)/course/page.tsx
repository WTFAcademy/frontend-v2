...
const CoursePage = () => {
  ...
  const { data, isLoading } = useQuery<
    Record<"published" | "unpublished", TCourse[]>
  >({
    queryKey: ["courses"],
    queryFn: async () => {
      ...
      <div id="course" className="w-full h-full flex flex-col">
        ...
        <section className="container w-full flex flex-col">
          <div className="w-full flex flex-col">
            <div className="flex items-center gap-x-3 px-8 mb-[-0.5px] md:px-10 py-9 border-wtf-border-divider border-[0.5px] border-solid mt-[-0.5px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 4xl:grid-cols-5 mt-[-0.5px] border-wtf-border-divider border-[0.5px] border-solid">
              {isLoading ? (
                <>
