...
const SectionBanner = () => {
  return (
    <section className="h-screen w-full bg-[url('/images/banner.jpeg')] bg-cover bg-center flex flex-col">
      ...
      <div className="w-full bg-wtf-black">
        <div className="container w-full h-[54px] flex items-center justify-around text-wtf-white uppercase font-roboto-mono text-[13px] tracking-[2.86px] overflow-hidden select-none">
          {[
            "Web3",
            "Open",
            "University",
