...
const h1 = ({ node, ...props }: any) => {
  return (
    <h1
      className="self-stretch text-[32px] font-bold leading-10 mt-4 mb-2"
      {...props}
    />
  );
};
...
const h2 = ({ node, ...props }: any) => {
  return (
    <h2
      className="self-stretch text-2xl font-bold leading-8 mt-4 mb-2"
      {...props}
    />
  );
};
...
const h3 = ({ node, ...props }: any) => {
  return (
    <h3
      className="self-stretch text-[22px] font-bold leading-7 mt-4 mb-2"
      {...props}
    />
  );
};
...
const h4 = ({ node, ...props }: any) => {
  return (
    <h4
      className="self-stretch text-xl font-bold leading-7 mt-4 mb-2"
      {...props}
    />
  );
};
...
const h5 = ({ node, ...props }: any) => {
  return (
    <h5
      className="self-stretch text-lg font-bold leading-6 mt-3 mb-1"
      {...props}
    />
  );
};
...
const h6 = ({ node, ...props }: any) => {
  return (
    <h6
      className="self-stretch text-base font-bold leading-6 mt-3 mb-1"
      {...props}
    />
  );
};
...
const p = ({ node, ...props }: any) => {
  return (
    <p className="self-stretch text-base font-normal leading-7" {...props} />
  );
};
...
const thead = ({ node, ...props }: any) => {
  return (
    <thead
      className="bg-[#F3F4F6] border-b border-[#E5E7EB] divide-x"
      {...props}
    />
  );
};
        ...
        return (
          <div className="relative">
            <pre {...rest}>
              ...
              >
                {display ? (
                  <Icons.copyOutline className="text-gray-500" />
                ) : (
                  <Icons.checkOutline className="text-gray-500" />
                )}
              </div>
              {children}
            </pre>
