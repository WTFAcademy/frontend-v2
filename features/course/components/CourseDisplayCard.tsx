...
const CourseDisplayCard = ({
  ...
  return (
    <div className="course-display-card w-full p-8 md:p-10 border-wtf-border-divider border-r-[0.5px] border-b-[0.5px] border-solid flex flex-col items-center gap-y-8">
